...
public class MainInterface extends JFrame implements ActionListener {
    ...
    public static void main(String args[]) {
        ...
        for (int i = 0; i < 1; i++) {
            ...
            tempRecord = rafEmployeeFile.getNextRecordE(i);
            test[i] = tempRecord;
        }
    ...
    public void checkLogin() throws Exception {
        ...
        if (isNumeric(txtEmployee.getText())) {
            ...
            for (int i = 0; i < test.length; i++) {
                ...
                if (test[i].getPassword().equals(tempHash) && tempNumber == test[i].getEmployeeNumber() && test[i].getPosition().equalsIgnoreCase("manager")) //if (test[0].getPassword().equals(tempHash)) 
                {
                ...
                //If password and temporary number equal the actual employee number/password
                if (test[i].getPassword().equals(tempHash) && tempNumber == test[i].getEmployeeNumber() && test[i].getPosition().equalsIgnoreCase("cashier")) //if (test[0].getPassword().equals(tempHash)) 
                {
